...
const chats: Chat[] = [
  ...
  },
  {
    id: 3,
    summary:
      "A new option that uses Meta AI to privately and quickly summarize unread messages in a chat, so you can get an idea of what is happening.",
    lastAccessed: "2025-10-05T12:30:00Z",
  },
  {
    id: 4,
    summary: "As a new option that uses Meta AI to privately.",
    lastAccessed: "2025-09-28T10:15:00Z",
  },
  {
    id: 5,
    summary:
      "This is a new option that uses Meta AI to privately and quickly summarize unread messages in a chat, so you can get an idea of what is happening.",
    lastAccessed: "2025-09-27T18:45:00Z",
  },
  {
    id: 6,
    summary:
      "A new option that uses Meta AI to privately and quickly summarize unread messages in a chat, so you can get an idea of what is happening.",
    lastAccessed: "2025-09-26T12:30:00Z",
  },
  {
    id: 7,
    summary:
      "As a new option that uses Meta AI to privately and quickly summarize unread messages in a chat, so you can get an idea of what is happening.",
    lastAccessed: "2025-09-28T10:15:00Z",
  },
  {
    id: 8,
              ...
              <div key={chat.id} className="chat-item">
                <div className="d-flex flex-column">
                  ...
                  <span className="accessed">
                    Last updated on: {formatDate(chat.lastAccessed)}
                  </span>
                </div>
              </div>
            ))
